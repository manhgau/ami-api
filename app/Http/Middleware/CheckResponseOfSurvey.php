...
class CheckResponseOfSurvey
{
    public function handle($request, Closure $next)
    {
        ...
        if (($number_of_response_user >=  $user_package->response_limit) || (($survey_user->limmit_of_response_anomyous != 0) & ($number_of_response_survey >= $survey_user->limmit_of_response_anomyous))) {
